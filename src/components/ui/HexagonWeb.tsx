      ...
      {items.slice(0, 6).map((item, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary/20 to-accent/10 flex items-center justify-center mb-2 group-hover:from-primary/30 group-hover:to-accent/20 transition-colors duration-300">
              ...
              {item.desc && (
                <span className="text-[10px] text-muted-foreground text-center leading-snug mt-1">
                  {item.desc}
                </span>
              )}
            </motion.div>
