...
const ChatBot = () => {
  ...
  const quickResponses = [
    "Tell me about AI-ready data centers",
  ...
  return (
    <>
      ...
      <Button
        ...
        size="lg"
        className={cn(
          "fixed bottom-6 right-6 z-50 rounded-full w-16 h-16 shadow-lg ai-pulse",
          isOpen && "rotate-180"
        )}
      >
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-24 right-6 w-96 h-[500px] z-40 bg-card border-primary/20 ai-glow animate-slide-up">
              ...
              <div className="grid grid-cols-1 gap-2 mb-4">
                {quickResponses.map((response, index) => (
                  <Button
                    ...
                    className="justify-start text-left h-auto py-2 px-3 text-xs hover:bg-primary/10"
                  >
                    {response}
                  </Button>
                ))}
