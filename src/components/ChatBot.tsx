          ...
          <CardContent className="p-0 flex flex-col h-[calc(500px-80px)]">
            ...
            <div className="p-4 border-t border-primary/20">
              <div className="grid grid-cols-1 gap-2 mb-4">
                {quickResponses.map((response, index) => <Button key={index} variant="ghost" size="sm" onClick={() => handleQuickResponse(response)} className="justify-start text-left h-auto py-2 px-3 text-xs hover:bg-blue-100">
                    {response}
                  </Button>)}
              </div>
