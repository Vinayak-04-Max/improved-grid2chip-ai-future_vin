...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-void border-t border-primary/20 overflow-hidden">
      {/* Background effects */}
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-fib-34">
          ...
          <motion.div variants={itemVariants} className="space-y-fib-21">
            ...
            <div className="flex gap-fib-13">
              ...
              <motion.a
                href="mailto:info@grid2chip.com"
                className="p-fib-8 rounded-fib bg-surface border border-border hover:border-primary transition-colors group"
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
          ...
          <motion.div variants={itemVariants} className="space-y-fib-21">
            ...
            <div className="space-y-fib-13">
              {[
                { to: "/solutions/ai-ready", label: "AI-Ready Data Centers" },
                { to: "/solutions/container", label: "Container Data Centers" },
                { to: "/solutions/edge", label: "Edge Data Centers" },
                { to: "/solutions/prefab", label: "Prefabricated Data Centers" },
                { to: "/solutions/hpc", label: "HPC Data Centers" },
              ].map((link) => (
                <Link
                  key={link.to}
                  to={link.to}
                  className="block text-sm text-muted-foreground hover:text-primary transition-colors link-underline"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <motion.div variants={itemVariants} className="space-y-fib-21">
            ...
            <div className="space-y-fib-13">
              ...
              <div className="space-y-fib-8 pt-fib-8">
                <Link
                  to="/demo"
                  className="block text-sm text-primary hover:text-primary-glow transition-colors font-medium"
                >
                  Book a Demo →
                </Link>
                <Link
        ...
        <motion.div
          ...
          className="border-t border-primary/10 mt-fib-55 pt-fib-21"
        >
