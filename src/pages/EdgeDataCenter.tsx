...
import { 
  Zap, Globe, Cpu, Shield, Clock, Network, ArrowRight, CheckCircle, 
  Car, Factory, HeartPulse, Building2, TrendingUp, Server, Wifi, Lock,
...
const EdgeDataCenter = () => {
  ...
  const specifications = [
    { label: "Latency", value: "<1ms", icon: Clock, description: "Response time" },
    { label: "Availability", value: "99.998%", icon: TrendingUp, description: "Uptime guarantee" },
    { label: "Deployments", value: "1000+", icon: Server, description: "Global locations" },
    { label: "Connectivity", value: "5G/Fiber", icon: Wifi, description: "Network options" },
    { label: "Security", value: "Zero Trust", icon: Lock, description: "Security model" },
    { label: "Scalability", value: "Auto", icon: Cpu, description: "Dynamic scaling" }
  ];
              ...
              {edgeFeatures.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative p-8 rounded-3xl bg-gradient-to-br from-card/60 to-transparent border border-primary/10 hover:border-primary/30 transition-all duration-500 group">
                      {/* Metric Badge */}
                      <div className="absolute -top-3 -right-3 px-3 py-1 rounded-full bg-gradient-to-r text-xs font-bold text-white" 
                  ...
                  <div className="flex-grow">
                    <div className="relative h-4 rounded-full bg-card overflow-hidden mb-4">
                      <motion.div
                        ...
                        initial={{ width: 0 }}
                        whileInView={{ width: `${type.scale}%` }}
                        viewport={{ once: true }}
                        transition={{ duration: 1, delay: index * 0.2 }}
                      />
                      <div className="absolute inset-0 flex items-center justify-end pr-2">
                        <span className="text-xs font-bold text-white drop-shadow-lg">{type.scale}%</span>
                      </div>
                    </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-primary/10">
                          <div className="flex flex-wrap gap-2">
                            {useCase.benefits.map((benefit, i) => (
                              <span key={i} className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-accent/10 text-accent">
