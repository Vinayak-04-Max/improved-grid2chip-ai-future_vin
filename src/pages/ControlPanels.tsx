              ...
              <div className="flex justify-center pt-8">
                <div className="relative w-[420px] h-[260px]">
                  <svg viewBox="0 0 420 260" className="w-full h-full mx-0">
                    <defs>
                      <linearGradient id="cpArcGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <path d="M 30 250 A 180 180 0 0 1 390 250" fill="none" stroke="url(#cpArcGradient)" strokeWidth="40" strokeLinecap="round" opacity="0.9" />
