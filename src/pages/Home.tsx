...
const Home = () => {
  ...
  const industries = [{
    ...
    icon: Ship,
    desc: "Supply chain operations"
  }, {
    name: "Semi Conductors",
    icon: Cpu,
    desc: "Chip manufacturing"
  }, {
    name: "Manufacturing",
    icon: Factory,
  ...
  const services = [{
    ...
    icon: Building2,
    path: "/services/bms",
    desc: "Centralized control and automation"
  }, {
    title: "DCIM Solutions",
    icon: Globe,
    path: "/services/ims",
    desc: "Real-time asset monitoring"
  }, {
    title: "Integrated Monitoring",
    icon: CheckCircle,
    path: "/services/ims",
    desc: "Unified oversight dashboard"
  }, {
    title: "ELV & Fire Safety",
    icon: Shield,
    path: "/services/elv",
    desc: "Maximum safety & security"
  }, {
    title: "Control Panels",
    icon: Cpu,
    path: "/services/control-panels",
    desc: "Custom automation panels"
  }, {
    title: "Operations & Maintenance",
    icon: Zap,
    path: "/services/ims",
    desc: "Proactive AMC services"
  }];
  const stats = [{
    value: "99.998%",
    label: "Uptime",
  ...
  return <div ref={containerRef} className="min-h-screen bg-background overflow-hidden">
      ...
      {/* Clean White Background */}
        ...
        <motion.div className="absolute inset-0 tech-grid-3d opacity-30" animate={{
        opacity: [0.2, 0.4, 0.2]
      }} transition={{
        duration: 8,
        repeat: Infinity,
              ...
              <StaggerReveal className="grid grid-cols-3 gap-4 sm:gap-fib-34 w-full sm:max-w-2xl mx-auto py-fib-34" staggerDelay={0.15}>
                ...
                return <MagneticArea key={stat.label} intensity={0.15}>
                    ...
                    damping: 17
                        ...
                        <motion.div className="flex items-center justify-center gap-fib-8 mb-fib-5" animate={{
                      y: [0, -3, 0]
                    }} transition={{
                      duration: 3,
                      repeat: Infinity,
        ...
        <motion.div className="absolute bottom-fib-55 left-1/2 -translate-x-1/2" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        delay: 2
          ...
          <motion.div className="flex flex-col items-center gap-fib-8" animate={{
          y: [0, 10, 0]
        }} transition={{
          duration: 2,
          repeat: Infinity
                  ...
                  <ScrollRevealBlock variant="scale" delay={index * 0.1} className="h-full">
                    <RefractiveCard className="h-full group">
                      <div className="p-fib-21 flex flex-col h-[320px] relative overflow-hidden">
                        ...
                        {/* Icon with pulse */}
                        <motion.div className={`w-fib-55 h-fib-55 rounded-fib-lg flex items-center justify-center mb-fib-21 flex-shrink-0 ${solution.color === 'primary' ? 'bg-primary/20' : 'bg-accent/20'} relative`} whileHover={{
                      scale: 1.1,
                      rotate: 5
                    }} transition={{
                      type: "spring",
                      stiffness: 300
                          ...
                          <motion.div className="absolute inset-0 rounded-fib-lg border border-primary/30" animate={{
                        scale: [1, 1.2, 1],
                        opacity: [0.5, 0, 0.5]
                      }} transition={{
                        duration: 2,
                        ...
                        <Link to={solution.path} className="inline-flex items-center gap-fib-8 text-sm font-medium text-primary hover:text-primary-glow transition-colors group/link mt-auto flex-shrink-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-fib-21 items-stretch">
            ...
            return <Link key={service.title} to={service.path} className="h-full">
                ...
                damping: 22
                    ...
                    <div className={`w-fib-55 h-fib-55 rounded-fib-lg flex items-center justify-center mb-fib-21 flex-shrink-0 ${index % 2 === 0 ? "bg-primary/20" : "bg-accent/20"}`}>
        ...
        <div className="fib-container relative z-10">
          <ScrollRevealBlock variant="morph">
            ...
            boxShadow: '0 0 100px hsl(var(--primary) / 0.2)'
              ...
              {/* Animated border */}
              <motion.div className="absolute inset-0 rounded-fib-xl" style={{
