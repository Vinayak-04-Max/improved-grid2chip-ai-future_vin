...
const HPC = () => {
  ...
  const specifications = [{
    ...
    unit: "per rack",
    scale: 100,
    applications: ["AI training", "Deep learning", "Scientific simulation"],
    ideal: "GPU-intensive workloads"
  }, {
    label: "Networking",
    value: "400 Gbps",
    unit: "InfiniBand",
    scale: 85,
    applications: ["Low-latency interconnect", "Parallel processing", "MPI clusters"],
    ...
    unit: "Scale",
    scale: 90,
    applications: ["Large datasets", "Parallel file systems", "NVMe arrays"],
    ideal: "Data-intensive research"
  }, {
    label: "PUE Rating",
    value: "< 1.2",
    unit: "Efficiency",
    scale: 95,
    applications: ["Liquid cooling", "Heat recovery", "Precision airflow"],
    ideal: "Sustainable operations"
  }];
  const useCases = [{
  ...
  const processSteps = [{
    step: "01",
    title: "Assessment",
    description: "Analyze your computational requirements and workloads",
    duration: "1 Week"
  }, {
    step: "02",
    title: "Architecture",
    description: "Design optimal HPC infrastructure for your needs",
    duration: "2 Weeks"
  }, {
    step: "03",
    title: "Procurement",
    description: "Source and configure specialized HPC hardware",
    duration: "4 Weeks"
  }, {
    step: "04",
    title: "Deployment",
    description: "Install, integrate, and optimize your HPC environment",
    duration: "3 Weeks"
  }, {
    step: "05",
    title: "Operations",
    description: "Ongoing management, monitoring, and support",
    duration: "Continuous"
  }];
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[85vh] flex items-center">
        ...
        <div className="absolute inset-0">
          <img src={heroImage} alt="HPC Data Center" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          duration: 0.8
            ...
            <p className="text-xl lg:text-2xl mb-8 leading-relaxed max-w-2xl text-accent-foreground">
      ...
      <section className="py-16 lg:py-20 border-y border-primary/10 bg-card/30">
        ...
        <div className="relative overflow-hidden">
          ...
          ease: "linear"
            ...
            return <div key={index} className="flex-shrink-0 w-80 p-6 rounded-2xl bg-gradient-to-br from-card/90 to-card/60 border border-primary/20 hover:border-primary/40 transition-all duration-300 group">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-6 p-6 rounded-2xl bg-gradient-to-r from-card/60 to-transparent border border-primary/10 hover:border-primary/30 transition-all duration-300">
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {spec.applications.map((app, i) => <span key={i} className="px-3 py-1 rounded-full text-xs font-medium bg-primary/10 text-primary border border-primary/20">
                          {app}
                        </span>)}
                    </div>
                  </div>
                ...
                delay: index * 0.1
                    ...
                    <div className={`p-5 rounded-2xl bg-gradient-to-br from-card/95 to-card/80 border ${colors} transition-all duration-300 group`}>
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="font-display font-bold text-foreground mb-1 text-xl">{useCase.title}</h3>
