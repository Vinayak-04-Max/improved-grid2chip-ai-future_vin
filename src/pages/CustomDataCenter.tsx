          ...
          <div className="hidden lg:block">
            <div className="relative max-w-5xl mx-auto">
              ...
              <div className="absolute right-0 top-0 w-[280px] space-y-12 z-20">
                ...
                const Icon = advantage.icon;
                return <motion.div key={advantage.title} className="flex items-start gap-4 flex-row-reverse text-right" initial={{
                  opacity: 0,
                  x: 30
                }} whileInView={{
                  opacity: 1,
              ...
              <div className="flex justify-center pt-8">
                <div className="relative w-[420px] h-[260px]">
                  <svg viewBox="0 0 420 260" className="w-full h-full mx-0">
                    <defs>
                      <linearGradient id="cdcArcGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <path d="M 30 250 A 180 180 0 0 1 390 250" fill="none" stroke="url(#cdcArcGradient)" strokeWidth="40" strokeLinecap="round" opacity="0.9" />
          ...
          <div className="hidden lg:grid grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              once: true
                ...
                {/* Center */}
                <div className="absolute inset-5 rounded-full bg-gradient-to-br from-card to-card/90 border border-primary/30 flex items-center justify-center shadow-xl text-primary bg-primary-foreground">
                  <div className="text-center text-primary bg-primary-foreground">
                    ...
                    <span className="font-display font-bold leading-tight bg-primary-foreground text-primary text-sm">Custom<br />Solutions</span>
                  </div>
                </div>
              </motion.div>
