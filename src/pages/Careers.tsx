...
const Careers = () => {
  ...
  const companyPerks = ["Flexible work arrangements", "Annual learning budget ₹50,000", "International conference attendance", "State-of-the-art office facilities", "Free meals and snacks", "Gym membership reimbursement", "Team building events", "Innovation time (20% for research)", "Employee stock options", "Relocation assistance", "Parental leave policy", "Birthday & work anniversary gifts"];
  const departments = [{
    name: "Engineering",
    openings: 0,
    description: "Build the future of infrastructure"
  }, {
    name: "Operations",
    openings: 0,
    description: "Deliver excellence in project execution"
  }, {
    name: "R&D",
    openings: 0,
    description: "Pioneer next-generation technologies"
  }, {
    name: "Sales",
    openings: 0,
    description: "Drive growth and client success"
  }, {
    name: "Support",
    openings: 0,
      ...
      <section className="py-20 lg:py-32 bg-gradient-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            return <Card key={index} className="text-center bg-card border-primary/20 hover:border-primary/40 transition-all duration-300">
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            const bgColor = index % 2 === 0 ? "bg-primary" : "bg-accent";
            return <Card key={index} className="bg-gradient-card border-primary/20 hover:border-primary/40 transition-all duration-300">
                  <CardHeader>
